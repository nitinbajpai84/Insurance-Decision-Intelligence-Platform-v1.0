-- Existing-database preparation script.
--
-- Use this when you ALREADY created the base tables and loaded older CSV data.
-- Do NOT rerun 001_insurance_analytics_mvp_schema.sql in that case, because
-- the base tables such as public.parties already exist.
--
-- This script:
--   1. Clears existing synthetic CSV data.
--   2. Adds rider-aware columns if missing.
--   3. Recreates rider/NBP analytics views.
--
-- After this completes, reload the updated CSVs from the data/ folder.
